    ...
    ${b.section('What should be in a first fly box?', `
      ...
      ${b.table(
        ...
        [
          ...
          ['Buggy nymph', `${b.flyLink('gold-ribbed-hares-ear')}`, '#12, #14, #16', 'A different silhouette when the slim one is refused'],
          ...
          ['Terrestrial', `${b.flyLink('foam-beetle')}`, '#12, #14', 'Summer, wind, and grassy banks'],
